...
#define RENDER_DISTANCE (2) // x z
//* Remember to change worldgen when changing this!
#define RENDER_HEIGHT (64/WORLD_CHUNK_NY)
#define WORLD_NCHUNKS (RENDER_DISTANCE*RENDER_DISTANCE*RENDER_HEIGHT)

//** GENERATION **//

#define MAX_CHUNK_UPDATES_PER_DISPATCH 1
...
static_assert(MAX_CHUNK_UPDATES_PER_DISPATCH <= RENDER_DISTANCE*RENDER_DISTANCE);
#endif